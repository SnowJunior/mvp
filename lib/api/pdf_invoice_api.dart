...
class PdfInvoiceApi {
  static Future<File> generate(Invoice invoice) async {
    ...
    return PdfApi.saveDocument(name: "my_invoice_pdf", pdf: pdf);
  }
  ...
  static Widget buildInvoice(Invoice invoice) {
    ...
    final data = invoice.items.map((items) {
      final total = items.quantity * items.unitPrice;
  ...
  static Widget buildTotal(Invoice invoice) {
    ...
    final total = netTotal + (0.19 * invoice.items.first.unitPrice);
